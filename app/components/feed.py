...
def sort_buttons() -> rx.Component:
    return rx.hstack(
        rx.button(
            ...
            size="4",
            class_name="bg-[#4A90E2] text-[#1F1F1F] px-6 py-3 rounded-lg border-4 border-[#1F1F1F] shadow-[4px_4px_0px_0px_rgba(31,31,31,1)] hover:shadow-[2px_2px_0px_0px_rgba(31,31,31,1)] hover:translate-x-0.5 hover:translate-y-0.5 transition-all duration-300",
        ),
        rx.button(
            rx.hstack(
            ...
            size="4",
            class_name="bg-[#FF6347] text-[#1F1F1F] px-6 py-3 rounded-lg border-4 border-[#1F1F1F] shadow-[4px_4px_0px_0px_rgba(31,31,31,1)] hover:shadow-[2px_2px_0px_0px_rgba(31,31,31,1)] hover:translate-x-0.5 hover:translate-y-0.5 transition-all duration-300",
        ),
        spacing="4",
        class_name="mb-4",
    )
